...
var DOMstrings = {
  inputType: '#app16_select_id_0',
  inputDescription: '#app16_input_id_0',
  inputValue: '#app16_input_id_1',
  inputBtn: 'button.btn-block',
  incomeContainer: '.income__list',
  expensesContainer: '.expenses__list',
  budgetLabel: '#app16_results_span_content_2',
  incomeLabel: '#app16_results_span_content_0',
  expenseLabel: '#app16_results_span_content_1',
  percentageLabel: '#app16_results_span_content_sign_1',
...
return {
  ...
  addListItem: function (obj, type) {
    ...
    if (type === 'inc') {
      ...
      html = 	'<div class="item clearfix" id="inc-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__delete"><button class="item__delete--btn"><i class="fa fa-window-close">x</i></button></div></div></div>';
    } else if (type === 'exp') {
      element = DOMstrings.expensesContainer;
      html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="fa fa-window-close">x</i></button></div></div></div>';
    }
