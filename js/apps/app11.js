let error1,result,copied;
if (whatLang() == "el") {
  error1 = "Υπήρχε κάποιο σφάλμα, παρακαλώ προσπαθήστε αργότερα.";
  copied = "Αντιγράφηκε!";
} else {
  error1 = "There was an error, please check again later.";
  copied = "Copied!";
}
...
$.getJSON('https://ipapi.co/json/', function(data) {
  ...
  result = result[0][1];
   document.getElementById('app11_textarea_id_0').textContent = result;
}).error(function() { 
  document.getElementById('app11_textarea_id_0').textContent = error1;
});
